...
//
// Emulates a KB Gear Jam Studio Tablet (VID: 0x084e, PID: 0x1001),
...
#define USB_VENDOR	0x084e	// KB Gear
#define USB_PRODUCT	0x1001	// Jam Studio Tablet
...
void *ep_int_in_loop(void *arg) {
	...
	// data packet
	io.inner.data[0] = 0x02;	// BTN_RIGHT
	io.inner.data[5] = 0x10;	// BTN_LEFT (ABS_PRESSURE)
	ep_int_in_send_packet(fd,&io);

	io.inner.data[0] = 0x01;	// BTN_TOUCH
	io.inner.data[5] = 0x11;	// BTN_LEFT
	ep_int_in_send_packet(fd,&io);
